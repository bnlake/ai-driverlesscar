...
export default class Visualizer {
	static drawNetwork(ctx: CanvasRenderingContext2D | null, network: NeuralNetwork | null) {
	...
	static getNodeX(nodes: Array<number>, index: number, left: number, right: number) {
